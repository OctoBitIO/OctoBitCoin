...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://explorer.octobit.io:8080/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.octobit.io:8080/tx/%s").toString();
