...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OCTO");
    case mBTC: return QString("mOCTO");
    case uBTC: return QString::fromUtf8("μOCTO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("OctobitCoins"));
    case mBTC: return QString(QObject::tr("Milli-OctobitCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-OctobitCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
